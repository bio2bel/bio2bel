...
# -*- coding: utf-8 -*-
#
# Bio2BEL documentation build configuration file, created by
# sphinx-quickstart on Sun Nov 12 12:13:28 2017.
#
...
latex_documents = [
    (master_doc, 'Bio2BEL.tex', 'Bio2BEL Documentation',
...
texinfo_documents = [
    (master_doc, 'Bio2BEL', 'Bio2BEL Documentation',
     author, 'Bio2BEL', 'Converting Biological Databases to BEL.',
     'Miscellaneous'),
]
